...
const benefits = [
  {
    ...
    desc: "Все чистящие средства сертифицированы и безопасны для мест общественного питания.",
  },
  {
    icon: Clock,
    title: "Работаем без выходных",
    desc: "Выезжаем в удобное для вас время — ночью, рано утром или в обеденный перерыв.",
  },
  {
    icon: Sparkles,
    title: "Профессиональное оборудование",
    desc: "Экстракторы Karcher и профессиональная химия для идеального результата.",
  },
  {
    icon: FileText,
    title: "Договор и документы",
    desc: "Заключаем договор на разовое или регулярное обслуживание. Предоставляем все закрывающие документы.",
  },
];
